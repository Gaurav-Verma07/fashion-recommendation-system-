  ...
  return (
    <section className={classes.main}>
      <div className={classes.body}>
        <Title color="grey" mb={30}> Welcome to While Collection </Title>
        <Text>
        ...
        <Button className={classes.generateBtn} pb={10} pt={10} onClick= {()=>{navigate('/generate')}} >Let's Create</Button>
      </div>
    </section>
  );
};
